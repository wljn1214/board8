     ...
     <tr>
      <td colspan="4"> 	
       <a class="btn btn-dark btn-sm"
          href="/BoardPaging/WriteForm?menu_id=${vo.menu_id}&nowpage=${nowpage}">새 글 쓰기</a>
      
      <c:if test="${ login.userid eq vo.writer  }">
       <a class="btn btn-dark btn-sm"
          href="/BoardPaging/UpdateForm?idx=${vo.idx}&menu_id=${vo.menu_id}&nowpage=${nowpage}">수정</a>
       <a class="btn btn-dark btn-sm"
          href="/BoardPaging/Delete?idx=${vo.idx}&menu_id=${vo.menu_id}&nowpage=${nowpage}">삭제</a>
      </c:if>    
